 ...
 *
 * I learned setRGB on stack overflow but I can no longer find that thread:(
 * */
package FlappyBird;
import java.awt.*;
...
public class Game implements ActionListener, KeyListener
{
	...
	private final String[] BACKGROUNDOPTIONS = {"Light","Dark"};
	private final JFrame PLAYGROUND;
	...
	/**
	 * The initial commands for setting up the environment
	 */
	...
	/**
	 * Initial prompt for the background color of the environment
	 */
	private void colorPrompt() {
		int background = JOptionPane.showOptionDialog(null,"Select your background color:",
				"Flaps",
				JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, BACKGROUNDOPTIONS, BACKGROUNDOPTIONS[0]);
		switch (background) {
			case 0 -> bac = Color.lightGray;
			case 1 -> bac = Color.black;
		}
	...
	public void jump()
	{
		...
		playSound("/Users/hirbod/IdeaProjects/ICS4UE/Flappy Bird/src/wing.wav");
	}
		...
		if (started)
		{
			...
			for (Rectangle column : COLUMNS) {
				if (column.y == 0 && bird.x + bird.width / 2 > column.x + column.width / 2 - 10 && bird.x + bird.width / 2 < column.x + column.width / 2 + 10) {
					score++;
					if (!gameOver)
						playSound("/Users/hirbod/IdeaProjects/ICS4UE/Flappy Bird/src/point.wav");
				}
	...
	/**
	 * repaints graphic objects everytime that is called
	 */
